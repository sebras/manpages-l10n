...
grep -a -v "Norwegian bokmål translation of manpages" |
...
case $(basename "$translation") in
	tar.1.po ) echo ".Sh OVERSETTELSE" >> "$addendum" ;;
	* ) echo ".SH OVERSETTELSE" >> "$addendum" ;;
esac
echo "Den norske oversettelsen av denne manualsiden er laget av" >> "$addendum"
