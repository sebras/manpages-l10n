...
grep -a -v "Dutch translation of manpages" |
...
case $(basename "$translation") in
	tar.1.po ) echo ".Sh VERTALING" >> "$addendum" ;;
	* ) echo ".SH VERTALING" >> "$addendum" ;;
esac
echo "De Nederlandse vertaling van deze handleiding is geschreven door" >> "$addendum"
