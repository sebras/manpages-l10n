...
grep -a -v "French translation of manpages" |
...
case $(basename "$translation") in
	tar.1.po ) echo ".Sh TRADUCTION" >> "$addendum" ;;
	* ) echo ".SH TRADUCTION" >> "$addendum" ;;
esac
echo "La traduction française de cette page de manuel a été créée par" >> "$addendum"
