...
grep -a -v "Swedish translation of manpages" |
...
case $(basename "$translation") in
	tar.1.po ) echo ".Sh ÖVERSÄTTNING" >> "$addendum" ;;
	* ) echo ".SH ÖVERSÄTTNING" >> "$addendum" ;;
esac
echo "Den svenska översättningen av denna manualsida skapades av" >> "$addendum"
